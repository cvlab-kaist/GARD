...
from depth_anything_3.utils.checkpoint_utils import resolve_ckpt_path
...
class RAE_DA3(nn.Module):
    ...
    def __init__(
        ...
        if mae_weight is not None:
            ...
            # Load weights (local path or "hf://<owner>/<repo>/<filename>")
            ckpt = torch.load(resolve_ckpt_path(mae_weight), map_location='cpu')

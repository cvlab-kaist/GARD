...
# CLEAN ROOT PATH 
# ================================================================================
DA3_CLEAN_ROOT_PATH = f"data/eval/da3_benchmark/clean"


# ================================================================================
# DEGRADED PATHS PER DATASET
# ================================================================================
DA3_LQ_ROOT_PATH_hiroom = f'data/eval/da3_benchmark/degraded'
DA3_LQ_ROOT_PATH_eth3d = f'data/eval/da3_benchmark/degraded'
DA3_LQ_ROOT_PATH_dtu = f'data/eval/da3_benchmark/degraded'
DA3_LQ_ROOT_PATH_dtu64 = f'data/eval/da3_benchmark/degraded'
DA3_LQ_ROOT_PATH_7scenes = f'data/eval/da3_benchmark/degraded'
DA3_LQ_ROOT_PATH_scannetpp = f'data/eval/da3_benchmark/degraded'
